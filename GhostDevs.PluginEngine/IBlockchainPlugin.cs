...
namespace GhostDevs.PluginEngine
{
    public interface IBlockchainPlugin : IDBAccessPlugin
    {
        ...
        public bool VerifySignature(string chainShortName, string publicKey, string messageBase16, string messagePrefixBase16, string signatureBase16, out string address, out string error);
