...
public partial class PhantasmaPlugin : Plugin, IBlockchainPlugin
{
    ...
    public void FetchBlocks()
    {
        do
        {
            ...
            while ( FetchByHeight(i) && OverallEventsLoadedCount < maxEventsForOneSession ) i++;
    ...
    public bool FetchByHeight(BigInteger blockHeight)
    {
        ...
        try
        {
            ...
            using ( ApiCacheDbContext databaseApiCacheContext = new() )
            {
                Database.ApiCache.BlockMethods.Upsert(databaseApiCacheContext,
                    "main", blockHeight.ToString(), timestampUnixSeconds, response);
            }
                ...
                for ( var txIndex = 0; txIndex < txs.Count(); txIndex++ )
                {
                    ...
                    for ( var eventIndex = 0; eventIndex < events.Count(); eventIndex++ )
                    {
                        ...
                        try
                        {
                            ...
                            //var dbEvent = new Database.Main.Event();
                            //dbEvent.PRICE = "test";
                            var added = false;
                            ...
                            switch ( kind )
                            {
                                case EventKind.Infusion:
                                {
                                    ...
                                    //var evnt = new Event(kind, addr, contract, data);
                                    //dbEvent.ChainId = ChainId;
                                    ...
                                    if ( infusionEventData.ChainName == "main" )
                                    {
                                        /*var test = TokenMethods.Upsert(databaseContext, ChainId,
                                    ...
                                    or EventKind.CrownRewards:
                                {
                                    ...
                                    /*TokenMethods.Upsert(databaseContext, ChainId,
                                            tokenEventData.Symbol, tokenEventData.Symbol);*/
