...
public partial class Endpoints
{
    ...
    public static async Task<TransactionResult> Transaction(
    ...
    )
    {
        ...
        try
        {
            ...
            transaction = await query.Select(x => new Transaction
                {
                    hash = x.HASH,
        ...
        return new TransactionResult
            { total_results = with_total == 1 ? totalResults : null, transactions = new []{ transaction } };
    }
}
