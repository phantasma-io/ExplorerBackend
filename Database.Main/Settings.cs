...
internal class Settings
{
    ...
    private Settings(IConfiguration section)
    {
        ...
        ConnectionString =
            $"Host={connectionSettings.Host};Username={connectionSettings.Username};Password={connectionSettings.Password};Database={connectionSettings.Database};MaxPoolSize=300;Timeout=60;Include Error Detail=true";
